...
namespace Agenda.Entity
{
    ...
    public class FiltroContacto
    {
        ...
        public String valorFiltro { get; set; } // VALOR QUE CONTIENE LO QUE COMPARARA EL FILTRO (STRING).
        public DateTime valorFiltroDate { get; set; } // VALOR QUE CONTIENE LO QUE COMPARARA EL FILTRO (STRING).
    }
}
